"""Agent Quality Ranking v1.4 (production post-pass; freeze after merge).

Shared by app.retriever and eval — keep in sync. Do not extend unless new Gold regressions.
"""
